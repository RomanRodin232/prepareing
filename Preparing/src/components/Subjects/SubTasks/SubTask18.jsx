...
export default function SubTask18({ topic, condition, solution }) {
  ...
  return (
    <div className="column">
      ...
      <p>
        {condition.text[1]} <img src={condition.images[1]} />
      </p>
      <div className="answer">
        <Button isActive={true} style={{ background: form.corr, marginLeft: "0rem" }}>
      ...
      <div>
        {form.vis && (
          <>
            ...
            <p>{solution.text[3]}</p>
            <img src={solution.images[3]} />
            <p>
              {solution.text[4]} <img src={solution.images[4]} />
            </p>
